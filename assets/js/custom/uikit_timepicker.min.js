		...
		init: function () {
			var t, e = this,
				i = function (t, e) {
					...
					for (i = t = t || 0, o = ""; i < e; i++) o = "" + i, i < 10 && (o = "0" + o), a["24h"].push({
						value: o + ":00"
					}), a["24h"].push({
						value: o + ":15"
					}), a["24h"].push({
						...
						a["24h"].push({
							...
							value: o + ":45 " //FIRST SET					
						})), 0 < i && i < 13 && 12 !== i && (a["12h"].push({
							value: o + ":00"
						}), a["12h"].push({
							value: o + ":15"
						}), a["12h"].push({
						...
						12 <= i && (0 === (o -= 12) && (o = 12), o < 10 && (o = "0" + String(o)), a["12h"].push({
							value: o + ":00"
						}), a["12h"].push({
							value: o + ":15"
						}), a["12h"].push({
