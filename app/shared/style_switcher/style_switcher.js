        ...
        return {
            ...
            link: function (scope, elem, attr) {
                ...
                scope.changeTheme = function($event,theme) {
                    ...
                    if(theme.class == '') {
                        localStorage.removeItem('cllc_theme');
                        $('#kendoCSS').attr('href','bower_components/kendo-ui/styles/kendo.material.min.css');
                    } else {
                        localStorage.setItem("cllc_theme", theme.class);
                ...
                if((localStorage.getItem("cllc_sidebar_mini") !== null && localStorage.getItem("cllc_sidebar_mini") == '1')) {
                ...
                $('#style_sidebar_mini')
                    .on('ifChecked', function(event){
                        localStorage.setItem("cllc_sidebar_mini", '1');
                        localStorage.removeItem('cllc_sidebar_slim');
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('cllc_sidebar_mini');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.miniSidebarActive = false;
                            $state.go($state.current, {}, {reload: true});
                ...
                // change input's state to checked if mini sidebar is active
                if((localStorage.getItem("cllc_sidebar_slim") !== null && localStorage.getItem("cllc_sidebar_slim") == '1')) {
                ...
                $('#style_sidebar_slim')
                    .on('ifChecked', function(event){
                        localStorage.removeItem('cllc_sidebar_mini');
                        localStorage.setItem("cllc_sidebar_slim", '1');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.slimSidebarActive = true;
                            $state.go($state.current, {}, {reload: true});
                ...
                if((localStorage.getItem("cllc_boxed_layout") !== null && localStorage.getItem("cllc_boxed_layout") == '1')) {
                ...
                $('#style_layout_boxed')
                    .on('ifChecked', function(event){
                        localStorage.setItem("cllc_boxed_layout", '1');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.boxedLayoutActive = true;
                            $state.go($state.current, {}, {reload: true});
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('cllc_boxed_layout');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                ...
                if(localStorage.getItem("cllc_theme") !== null) {
                    $rootScope.main_theme = localStorage.getItem("cllc_theme");
                } else {
